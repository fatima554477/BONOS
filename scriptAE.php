...
function showToastCalc(msg){
  $("#toastCalc").text(msg).fadeIn(200).delay(3000).fadeOut(400);
}
// ==== BOTÓN MANUAL ====
$(document).on('click','#btnRecalcDias',function(){
    totalfechas8();
});
$(document).on('click','#btnRecalcularTodo',function(){
    totalfechas8();
});		
