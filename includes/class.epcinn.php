...
public function Listado_DATOSBAN(){
    ...
    if ($session != '') {
        ...
        public function Listado_datos_bancariosPRO2($id){ $conn = $this->db(); $variablequery = "select * from 01DATOSBANCARIOS where id = '".$id."' "; return $arrayquery = mysqli_query($conn,$variablequery); }
