...
<img src="includes/contraer41.png" id="ocultar2" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;CARGA MASIVA DE UNIFORMES</p><div  id="mensajeCARGAMASIVAU"><div class="progress" style="width: 25%;">
 ...
 <option style="background: #c9e8e8" <?php if($DEPARTAMENTO == 'LIMPIEZA'){echo "selected";}; ?> value="LIMPIEZA">LIMPIEZA</option>
							...
							<table id="scroller" class="scroller">
            ...
            <option value="0">- Seleccione -</option>
										...
										<td><input type="text" class="form-control" id="validationCustom03" required=""  value="<?php echo $CMU_ARTICULO; ?>" name="CMU_ARTICULO"></td>
										<td><input type="text" class="form-control" id="validationCustom03" required=""  value="<?php echo $CMU_CANTIDAD; ?>" name="CMU_CANTIDAD"></td>
                                        <td><input type="text" class="form-control" id="validationCustom03" required=""  value="<?php echo $CMU_TALLA; ?>" name="CMU_TALLA"></td>
										<td><input type="text" class="form-control" id="validationCustom03" required=""  value="<?php echo $CMU_MARCA; ?>" name="CMU_MARCA"></td>
                                        <td><input type="file" class="form-control" id="validationCustom03" required=""  value="<?php echo $CMU_FOTO; ?>" name="CMU_FOTO"></td>
										...
										<td><input type="text" class="form-control" id="validationCustom03" required=""  value="<?php echo $CMU_OBSERVACIONES; ?>" name="CMU_OBSERVACIONES"></td>
									</tr>
               ...
               <tr>    
            <th>
	          <button class="btn btn-sm btn-outline-success px-5"  type="button" id="enviarCARGAMASIVAU">GUARDAR</button></th>
...
?>
   ...
   <div class="table-responsive">
    ...
    <br />
    <div>
     <table class="table table-striped table-bordered" style="width:105%"    id="reseteateCARGAUM" name="reseteateCARGAUM">
	...
	$row4 = mysqli_fetch_array($querycontrasnombre);
      ...
      ?>
       ...
       <th style="background:#c9e8e8"width="20%">OBSERVACIONES</th>	
		...
		<tr class="table table-striped table-bordered" style="width:105%"  >
       ...
       <td><input type="button" name="view" value="MODIFICAR" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs view_dataVPCARGAUU" /></td>
	   
	   
       <td><input type="button" name="view_databorraVPCARGAUU" value="BORRAR" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs view_databorraVPCARGAUU" /></td>
