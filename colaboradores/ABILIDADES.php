...
<img src="includes/contraer41.png" id="ocultar81" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;HABILIDADES EN JUEGOS</p><div  id="mensajeHABILIDADES"><div class="progress" style="width: 25%;">
        ...
        <div class="card">
          <div class="card-body">
                   ...
                   <?php if($conexion->variablespermisos('','ABILIDADES2','ver')=='si'){ ?>
...
<table class="table mb-0 table-striped">
            ...
            <th>
            <?php if($conexion->variablespermisos('','ABILIDADES','guardar')=='si'){ ?>


	          <button class="btn btn-sm btn-outline-success px-5"  type="button" id="enviarHABILIDADES1">GUARDAR</button ><?php } ?></th>
