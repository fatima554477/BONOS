...
<strong><p class="mb-0 text-uppercase" style="font-size:22px;">&nbsp;&nbsp;&nbsp;SOLO COLABORADORES </p> </strong> </div> 	    
			 
			 
			 
<div id="content" >     

			  <p class="mb-0 text-uppercase">&nbsp;&nbsp;&nbsp;MOSTRAR TODO
<img src="includes/contraertodos11.png" id="mostrartodos" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;CONTRAER TODO
<img src="includes/contraertodos2.png" id="ocultartodos" style="cursor:pointer;"/><strong style="font-size:22px;">&nbsp;<?php echo  isset($NOMBRE_1)?'  '.$NOMBRE_1:'';?>&nbsp;<?php echo  isset($NOMBRE_2)?'  '.$NOMBRE_2:'';?>&nbsp;
<?php echo  isset($APELLIDO_PATERNO)?' '.$APELLIDO_PATERNO:'';?>&nbsp; <?php echo  isset($APELLIDO_MATERNO)?' '.$APELLIDO_MATERNO:'';?>	 </p> </strong> </div>
