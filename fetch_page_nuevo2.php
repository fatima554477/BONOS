...
<img src="includes/contraer41.png" id="ocultar3" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;REPORTE DE BONOS PERSONAL DE ADMINISTRACIÓN DEL EVENTO</p></strong></div>
...
<?php 
require "clasesPERSONAL/script.filtro.php";
?>